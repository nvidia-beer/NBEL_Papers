...
> **See [Model Predictive Control (MPC)](Control.md#4-model-predictive-control-mpc) for fundamental MPC principles**
...
> **See [Kinematic Bicycle Model (KBM)](KBM.md) for detailed vehicle dynamics and extended state formulation**
...
> **See [Prescribed Error Sensitivity (PES)](PES.md) for learning rule stability and implementation insights**
...
- Framework: Nengo 3.2.0 ([NEF](NEF.md))
- Learning: [PES](PES.md) rule
- Optimization: SciPy [MPC](Control.md#4-model-predictive-control-mpc)
